<template>
    <div class="hello">
        <div>
            <mu-list>
                <mu-sub-header>Histórico recente de bate-papo</mu-sub-header>
                <mu-list-item avatar button :ripple="false" @click="chatwindow('1')">
                    ...
                    <mu-list-item-title>Sala de bate-papo 1</mu-list-item-title>
                    <mu-list-item-action>
                ...
                <mu-list-item avatar button :ripple="false" @click="chatwindow('2')">
                    ...
                    <mu-list-item-title>Sala de bate-papo 2</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-icon value="chat_bubble"></mu-icon>
                    </mu-list-item-action>
                </mu-list-item>
            ...
            <mu-list>
                <mu-sub-header>Atendimento ao Cliente</mu-sub-header>
                <mu-list-item avatar button :ripple="false" @click="chatRobot()">
                    ...
                    <mu-list-item-title>Atendimento ao cliente Dabai (grupo WeChat, informações de contato do autor, encontre-me)</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-icon value="chat_bubble"></mu-icon>
                    </mu-list-item-action>
                </mu-list-item>
            ...
            async chatwindow(roomID) {
                ...
                if (!uerId) {
                    const res = await Confirm({
                        title: "Pronto",
                        content: "Faça login no chat, mas você pode verificar o histórico do chat ~"
                    });
                    if (res === "submit") {
