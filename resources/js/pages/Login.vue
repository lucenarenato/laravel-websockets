  ...
  <div class="login">
    ...
    <div class="content">
      <form action="" name="form2">
        ...
        <br/>
        <div class="btn-radius" @click="submit">Conecte-se</div>
      </form>
      <div @click="register" class="tip-user">Registar Conta</div>
    </div>
  </div>
</template>
  ...
  methods: {
    async submit() {
      ...
      if (name !== "" && password !== "") {
        ...
        Alert({
          content: "Nome de usuário e senha não podem estar vazios"
        });
      }
    },
    register() {
